...
I, **Yoo Cheol WON**, am the copyright holder of yuchiri-axirad2D.
...
|---|---|
| Source code in `src/axirad2d/` | Third-party dependencies (NumPy, SciPy, mpi4py — each under its own BSD-family licence) |
...
본인 **원유철(Yoo Cheol WON)** 은 yuchiri-axirad2D 의 저작권자이다.
...
| 미치는 것 | 미치지 않는 것 |
|---|---|
| `src/axirad2d/` 의 소스 코드 | 제3자 의존성 (NumPy, SciPy, mpi4py — 각각 BSD 계열 자체 라이선스) |
